...
<div class="content-wrapper">
    ...
    <section class="content-header">
    	<h1>
        	Los Pagos de mi Hijo
        	<small>Vista</small>
        </h1>
        <ol class="breadcrumb">
        	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Pagos de Mi Hijo</a></li>
    	</ol>
	</section>
...
$name=$row['i_name'];
?>                    
                  		<h3 class="box-title">Mi Historico de Pagos</h3>
                	</div><!-- /.box-header -->
...
?>   
               ...
               <!--MSK-000115-td4--><td id="td_paid_<?php echo $count; ?>"><?php echo $row['paid']; ?></td>
                                    ...
                                    <td> 
<!--MSK-00102-->                                                
<a href="#" onClick="showModal3(this)" class="btn btn-info btn-xs" data-id="<?php echo $my_son_index; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>">Ver Detalles</a>
<a href="#" onClick="showModal4(this)" class="btn btn-success btn-xs" data-id="<?php echo $my_son_index; ?>,<?php echo $row['_status']; ?>,<?php echo $row['paid']; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>,<?php echo $row['date']; ?>" >Mirar Factura</a>
                               		</td>
                            	</tr>
<?php } } ?>
                        	</tbody>
