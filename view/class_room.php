            ...
            <div class="col-md-6"><!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">Añadir Clase</h3>
                	</div><!-- /.box-header -->
						...
						<div class="box-body">
                			<div class="form-group" id="divName">
                    			<label for="">Nombre</label>
                      			<input type="text" class="form-control" id="name" placeholder="Insertar el Nombre de la Clase" name="name" autocomplete="off">                    
                    		</div>
                    		<div class="form-group" id="divStudentCount">
                      			<label for="">Conteo de Estudiantes</label>
                      			<input type="text" class="form-control" id="student_count" placeholder="Insertar el Número del Conteo de Estudiantes" name="student_count"  		autocomplete="off">
                    		</div>
                		</div><!-- /.box-body -->
...
//MSK-000098-form submit
	...
	if(name == ''){
		...
		$('#divName').append('<span id="spanName" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El nombre es requerido" ></span>');	
	...
	if(student_count == ''){
		...
		$('#divStudentCount').append('<span id="spanStudentCount" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="El conteo de estudiantes es requerido" ></span>');	
        	...
        	<div class="col-md-8">
            	<div class="box">
                	<div class="box-header">
                  		<h3 class="box-title">Todas las Clases</h3>
                	</div><!-- /.box-header -->
                		...
                		<div class="panel">
        					<div class="panel-heading bg-orange">               
        						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          						<h4 class="modal-title custom_align" id="Heading">Editar Clase</h4>
   							</div>
                            ...
                            <div class="panel-footer bg-gray-light">
                                ...
                                <button type="button" onClick="Updateclassroom(this)" id="btnSubmit1" class="btn btn-info" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span> Actualizar</button>
                            </div><!--/.panel-footer-->  
            			</div><!--/.panel--> 
            		</div><!--/.col-md-6-->
            	</div><!--/.row-->                                    
...
//MSK-000108
	...
	if(name1 == ''){
		...
		$('#divNameUpdate').append('<span id="spanNameUpdate" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El nombre es requerido" ></span>');	
	...
	if(student_count1 == ''){
		...
		$('#divSCountUpdate').append('<span id="spanSCountUpdate" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="El conteo de estudiantes es requerido" ></span>');	
