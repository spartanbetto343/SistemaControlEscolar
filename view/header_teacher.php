...
<div class="wrapper">
  <header class="main-header" >
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><strong>CE</strong></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><strong>Control Escolar </strong></span>
    </a>
...
?>
                ...
                <ul class="dropdown-menu">
                  <li class="header">Tú tienes <?php echo $notfi_count; ?> notificaciones</li>
                  <li>
...
while($row=mysqli_fetch_assoc($result)){
	...
	echo '<li>
            <a href="#" onClick="showNotifyEvent('.$notification_id.')">
               <i class="fa fa-users text-aqua"></i> Tú tienes un nuevo evento - '.$title1.'
            </a>
         </li>
...
?>
                  ...
                  <li class="footer"><a href="#" onClick="viewAllNotifi()">Ver todos</a></li>
                </ul>
              </li>
<?php }  ?>           
...
?> 
              ...
              <li class="dropdown messages-menu" id="unread_msg">
                ...
                <ul class="dropdown-menu">
                  <li class="header">Tú tienes <?php echo $unread_msg_count; ?> mensajes</li>
            	...
            	<li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-header">
                        ...
                        <p>
                          ...
                          <?php
                                ...
                                echo '<small>'."Miembro desde ".date('M'.'.'.' Y', $date).'</small>';
                           ?>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      ...
                      <li class="user-footer">
                        <div class="pull-left">
                          <a href="teacher_profile2.php" class="btn btn-default btn-flat">Perfil</a>
                        </div>
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">¿Estas seguro?</strong>  ¿Quieres eliminar esta solicitud de amistad?
        		</div>
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYesReq" class="deletebtn btn btn-danger col-sm-2 pull-right">Si</a><!-- MSK-000125 -->
