...
$name=$row['i_name'];
?>                    
                  		<h3 class="box-title">Mi Historico de Salario</h3>
                	</div><!-- /.box-header -->
...
?>   
               ...
               <!--MSK-000115-td4--><td id="td_paid_<?php echo $count; ?>"><?php echo $row['paid']; ?></td>
                                    ...
                                    <td> 
<!--MSK-00102-->                                                
<a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $index; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>,<?php echo $count; ?>">Ver Detalles</a>
<a href="#" onClick="showModal3(this)" class="btn btn-success btn-xs" data-id="<?php echo $index; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>,<?php echo $count; ?>" >Mirar la Factura</a>
                               		</td>
                            	</tr>
<?php } } ?>
                        	</tbody>
