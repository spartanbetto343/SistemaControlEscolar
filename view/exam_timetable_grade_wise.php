...
?>                
        	<a href="#" onClick="showModal(this)" class="btn btn-success btn-sm pull-right" data-id="<?php echo $grade_id; ?>,<?php echo $exam_id; ?>">Añadir <span class="glyphicon glyphicon-plus"></span></a><!--MSK-000113-->
            <h3 class="box-title">Horario de Examen - <?php echo $row['name']; ?> - <?php echo $row1['name']; ?></h3>
<?php } ?>
		</div><!-- /.box-header -->
...
?>    	
                            ...
                            <?php echo $row['c_name']; ?><br>
                       		<a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>" data-toggle="modal">Editar</a><br><!--MSK-00131-Sunday-->  
  	 <!--MSK-00150-Sunday--><a href="#" class="confirm-delete btn btn-danger btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>">Eliminar</a><br>
...
?>    	
							<?php echo $row['s_name']; ?><br>
                            <?php echo $row['c_name']; ?><br>
                            <a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>" data-toggle="modal">Editar</a><br><!--MSK-00131-Monday-->  
  	 <!--MSK-00150-Monday--><a href="#" class="confirm-delete btn btn-danger btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>">Eliminar</a><br>
...
?>    	
							<?php echo $row['s_name']; ?><br>
                        	<?php echo $row['c_name']; ?><br>
                        	<a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>" data-toggle="modal">Editar</a><br><!--MSK-00131-Tuesday-->  
  	<!--MSK-00150-Tuesday--><a href="#" class="confirm-delete btn btn-danger btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>">Eliminar</a><br>
...
?>    	
							<?php echo $row['s_name']; ?><br>
                            <?php echo $row['c_name']; ?><br>
                            <a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>" data-toggle="modal">Editar</a><br><!--MSK-00131-Wednesday-->  
  <!--MSK-00150-Wednesday--><a href="#" class="confirm-delete btn btn-danger btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>">Eiminar</a><br>
...
?>    	
							<?php echo $row['s_name']; ?><br>
                            <?php echo $row['c_name']; ?><br>
                            <a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>" data-toggle="modal">Editar</a><br><!--MSK-00131-Thursday--> 
   <!--MSK-00150-Thursday--><a href="#" class="confirm-delete btn btn-danger btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>">Eliminar</a><br>
...
?>    	
							...
							<?php echo $row['s_name']; ?><br>
                            <?php echo $row['c_name']; ?><br>
                            <a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>" data-toggle="modal">Editar</a><br><!--MSK-00131-Friday-->  
  	 <!--MSK-00150-Friday--><a href="#" class="confirm-delete btn btn-danger btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>">Eliminar</a><br>
...
?>    	
							<?php echo $row['s_name']; ?><br>
                            <?php echo $row['c_name']; ?><br>
                            <a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>" data-toggle="modal">Editar</a><br><!--MSK-00131-Saturday-->
   <!--MSK-00150-Saturday--><a href="#" class="confirm-delete btn btn-danger btn-xs" data-id="<?php echo $row['ett_id']; ?>,<?php echo $grade_id; ?>,<?php echo $exam_id; ?>">Eliminar</a><br>
