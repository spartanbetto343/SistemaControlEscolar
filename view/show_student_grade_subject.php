            		...
            		<div class="panel panel-primary">
        				<div class="panel-heading">               	
                            <button type="button" onClick="showModalGrade()" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button><!--MSK-000128-->
          					...
          					<h3 class="panel-title">Añadir Asignatura de Estudiante</h3>
   						</div>
...
<?php } } ?>                            
            			...
            			<div class="panel-footer bg-blue-active">
                    		...
                    		<button type="button" class="btn btn-info " id="btnSubmit1" onClick="upgradeGrade(this)" style="width:100%;" ><span class="glyphicon glyphicon-ok-sign"></span>Enviar</button><!--MSK-000130-->
             			</div>
      				</div><!--/.panel-->
         		</div><!--/.col-md-3 --> 
            </div><!--/.row-->      
