...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Horarios de Examen</a></li>
        </ol>
	</section>
            ...
            <div class="col-md-5"><!-- left column -->
              	<div class="box box-primary"><!-- general form elements -->
                	<div class="box-header with-border">
                  		<h3 class="box-title">Anadir Horario de Examen</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body">
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	<button type="button" class="btn btn-primary"  onClick="showExamTimetable(this)">Siguiente</button><!--MSK-000108-->
                  	</div>
            	</div><!-- /.box -->
        	</div>
    	</div>
    		...
    		if (this.readyState == 4 && this.status == 200) {	
				...
				//MSK-000126-form submit
					...
					if(day == 'Select Day'){
						...
						$('#divDay').append('<span id="spanDay" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El dia es requerido" ></span>');	
					...
					if(subject == 'Select Subject'){
						...
						$('#divSubject').append('<span id="spanSubject" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La Asignatura es requerida" ></span>');	
					...
					if(classroom == 'Select Classroom'){
						...
						$('#divClassroom').append('<span id="spanClassroom" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La Clase es requerida" ></span>');	
					...
					if(end_time == ''){
						...
						$('#divEndTime').append('<span id="spanEndTime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La hora de finalización es obligatoria" ></span>');	
						...
						if (this.readyState == 4 && this.status == 200) {	
							...
							$("form").submit(function (e) {//MSK-000147-form submit
								...
								if(end_time == ''){
									...
									$('#divUpdateETime').append('<span id="spanUpdateETime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="La hora de finalización es obligatoria" ></span>');	
