...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-teacher"></i> Maestro</a></li>
            <li><a href="#"> Todos los Maestros</a></li>
         </ol>
     </section>
            ...
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Todos los Maestros</h3>
                    </div><!-- /.box-header -->
...
if($cant_remove1 > 0 || $cant_remove2 > 0 || $cant_remove3 > 0 || $cant_remove4 > 0 || $cant_remove5 > 0 || $cant_remove6 > 0 || $cant_remove7 > 0 || $cant_remove8 > 0 || $cant_remove9 > 0 || $cant_remove10 > 0){
	...
	echo '<a href="#modalUpdateform" onClick="showModal(this)" class="btn btn-warning btn-xs" data-id="'.$id.'" data-toggle="modal">Editar</a>';
	echo ' <a href="#" onClick="addSalary(this)" class="btn btn-success btn-xs"  data-id="'.$index.','.$id.'">Añadir Salario</a>';
	echo ' <a href="#" onClick="viewPayments(this)" class="btn btn-info btn-xs"  data-id="'.$index.'">Ver Pagos</a>';
            		...
            		<div class="col-md-6">
                		<div class="panel">
        					<div class="panel-heading bg-orange">               
                    			...
                    			<h4 class="modal-title custom_align" id="Heading">Editar Maestro</h4>
                			</div>
                			<form action="../index.php" method="post" enctype="multipart/form-data" id="form2">
                				<div class="panel-body"><!-- Start of the modal body--> 
                                    ...
                                    <div class="form-group" id="divINameUpdate">
                                        <label for="">Nombre con Iniciales</label>
                                ...
                                <div class="panel-footer bg-gray-light">
                                    ...
                                    <button type="submit" class="btn btn-info" id="btnSubmit1" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span> Actualizar</button>
                            	</div><!--/.panel-footer-->
                        	</form> 
            			</div><!--/.panel--> 
            		</div><!--/.col-md-6-->
				...
				$("#phone1" ).keydown(function(){//MSK-00119-phone
    				...
    				setTimeout(function() {
						...
						if (telformat.test(afterValue) == false){
							...
							mom.append('<span id="spanPhoneUpdate" class="glyphicon glyphicon-remove form-control-feedback msk-set-color-tooltip" data-toggle="tooltip" title="Introduce un número de teléfono válido" ></span>');	
				...
				$("#email1" ).keydown(function(){//MSK-00119-email
    				...
    				setTimeout(function() {
						...
						if (mailformat.test(afterValue) == false){
							...
							mom.addClass('has-error has-feedback');
							mom.append('<span id="spanEmailUpdate" class="glyphicon glyphicon-remove form-control-feedback msk-set-color-tooltip" data-toggle="tooltip" title="Introduzca una dirección de correo electrónico válida" ></span>');	
				...
				$('[type="file"]').change(function () {
					...
					var ext = $('#fileToUpload1').val().split('.').pop().toLowerCase();
						...
						if($.inArray(ext, ['png','jpg','jpeg']) == -1) {
							...
							$('#divPhotoUpdate1').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="Este tipo de archivo no está permitido" ></span>');
							...
							if(fileSize > maxSize) {
								...
								$("#btnSubmit1").attr("disabled", true);
								$('#divPhotoUpdate1').addClass('has-error has-feedback msk-col-md-4');	
								$('#divPhotoUpdate1').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="El tamaño de la imagen es demasiado grande." ></span>');		
...
//MSK-000098-form2 submit
	...
	if(full_name == ''){
		...
		$('#divFullNameUpdate').append('<span class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="El nombre completo es requerido" ></span>');
	...
	if(i_name == ''){
		...
		$('#divINameUpdate').append('<span class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="Las iniciales del nombre son requeridas" ></span>');
	...
	if(address == ''){
		...
		$('#divAddressUpdate').append('<span class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="La dirección es requerida" ></span>');
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">¿Estas Seguro?</strong> Quiere Eliminar este Registro
        		</div>
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYes" class="deletebtn btn btn-danger col-sm-2 pull-right">Si</a><!-- MSK-000130 -->
  		...
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(lastPaid == 0){
					...
					document.getElementById('lastPayment').innerHTML = "No asististe el mes pasado..!";
					document.getElementById('tSalary_lMonth').innerHTML = "Sin datos...!";
					document.getElementById('lastPaid').innerHTML = "Sin datos...!";
				}
				
				if(cSalary == 0){
					document.getElementById('currentSalary').innerHTML = "No tienes ninguna Aula..!";
					document.getElementById('currentPaid').innerHTML = "Sin datos...!";
					document.getElementById('dueAmount').innerHTML = "Sin datos...!";
				...
				if(d1 < 5){
					...
					document.getElementById('currentSalary').innerHTML="Su salario se generará en"+SalaryGDate;//7th July 2017 kiyala hadaganna balanna
					document.getElementById('currentPaid').innerHTML = "Sin datos..!";
					document.getElementById('dueAmount').innerHTML = "Sin datos..!";
					...
					if(status == "Total Salary"){
						...
						setTimeout(function() {
							...
							if(amount != tSalary){
								...
								$('#divAmount').append('<span id="spanAmount" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="El monto no es igual al Salario Total" ></span>');
								$("#btnSubmit").attr("disabled", true);
					...
					if(status == "Advance"){
						...
						setTimeout(function() {
							...
							if(amount > maxAdvance){
								...
								$('#divAmount').removeClass('has-success has-feedback');
								$('#divAmount').addClass('has-error has-feedback');
								$('#divAmount').append('<span id="spanAmount" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="Error" ></span>');
								$("#btnSubmit").attr("disabled", true);
