            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">Añadir Asignatura</h3>
                	</div><!-- /.box-header -->
                	...
                	<form role="form" action="../index.php" method="post">
                  		<div class="box-body">
                    		<div class="form-group" id="divSubject">
                      			...
                      			<input type="text" class="form-control" id="name" placeholder="Inserte el Nombre de la Asignatura" name="name" autocomplete="off">
                    		</div>
                  		</div><!-- /.box-body -->
...
//MSK-000098-form submit	
	...
	if(name == ''){
		...
		$('#divSubject').append('<span id="spanName" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La Asignatura es obligatoria" ></span>');	
			...
			<div class="col-md-7">
				<div class="box">
                	<div class="box-header">
						<h3 class="box-title">Todos las Asignaturas</h3>
                	</div><!-- /.box-header -->
                		...
                		<div class="panel">
        					<div class="panel-heading bg-orange">                 
        						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          						<h4 class="modal-title custom_align" id="Heading">Editar Asignatura</h4>
                            </div>
                            ...
                            <div class="panel-footer bg-gray-light">
                                ...
                                <button type="button" onClick="Updatesubject(this)" id="btnSubmit1" class="btn btn-info" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span> Actualizar</button>         
        	  				</div><!--/.panel-footer--> 
            			</div><!--/.panel-->
            		</div><!--/.col-md-6-->
            	</div><!--/.row-->                                        
...
//MSK-000108
	...
	if(name1 == ''){
		...
		$('#divSubjectUpdate').append('<span id="spanSubjectUpdate" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La Asignatura es requerida" ></span>');	
