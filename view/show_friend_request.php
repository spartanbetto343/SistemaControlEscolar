...
<ul class="dropdown-menu" id="dropdown_menu_frequest">
	<li class="header">Tú tienes <?php echo $unread_count; ?> peticiones de Amistad</li>
...
<button href="#" class="confirm-delete-friend-req btn btn-xs btn-danger" data-id="<?php echo $my_index; ?>,<?php echo $friend_index; ?>" ><i class="fa fa-user-plus" aria-hidden="true">Eliminar Petición</i></button>  
...
<?php }  ?> 
	...
	<li class="footer"><a href="#">Ver todas sus Peticiones de Amistad</a></li>
</ul>
