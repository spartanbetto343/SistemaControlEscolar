...
<div class="content-wrapper">
    ...
    <section class="content-header">
    	<h1>
        	La Asistencia de mi Hijo
        	<small>Vista</small>
        </h1>
        <ol class="breadcrumb">
        	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Asistencia</a></li>
            <li><a href="#">La Asistencia de mi Hijo</a></li>
    	</ol>
	</section>
 <script>
            ...
            <div class="col-md-12">
            	<div class="box">
                	<div class="box-header">
                    	<h3 class="box-title">La Asistencia de mi Hijo en Este Mes</h3>
                	</div><!-- /.box-header -->
                            ...
                            <div class=" col-md-7">
                                <table id="example1" class="table table-bordered table-striped">
                                	<thead>
                                        ...
                                        <th class="col-md-1">A Tiempo</th>
                                        <th class="col-md-1">Tarde</th>
                                    </thead>
                                   	<tbody>
<?php
...
<?php } ?>
                            ...
                            <div style="float:left; width:100px; ">
                                	<div style="background-color:#FF0033; width:15px; height:15px; float:left; margin-right:2px;"> </div> <span style="text-align:left;">  - Ausente </span><br> 
                                    <div style="background-color:#00FF66; width:15px; height:15px; float:left; margin-right:2px;"> </div> <span style="text-align:left;">  - Presente </span><br> 
                                    <div style="background-color:#FFCC33; width:15px; height:15px; float:left; margin-right:2px;"> </div> <span style="text-align:left;">  - No Asistio  </span><br> 
                            </div>
