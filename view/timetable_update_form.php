            		...
            		<div class="panel">
        				<div class="panel-heading bg-orange">               
        					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          					<h3 class="panel-title">Actualizar Horario </h3>
   						</div>
...
<?php }} ?> 	           
                                ...
                                <div class="form-group" id="divUpdateSTime">
        							...
        							<input type="text" class="form-control" id="start_time1" name="start_time" placeholder="Inserta una Hora de Inicio" autocomplete="off"/>
        						</div>  
                                 <div class="form-group" id="divUpdateETime">
                					<label for="" >Hora de Termino</label>
        							<input type="text" class="form-control" id="end_time1" name="end_time" placeholder="Inserte una Hora de Termino" autocomplete="off"/>
        						</div>  
            				</div><!--/.modal body-->
