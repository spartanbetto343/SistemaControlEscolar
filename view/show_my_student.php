...
if(mysqli_num_rows($result3) > 0){
	echo'<a href="#" class=" btn btn-success btn-xs" onClick="showModalEditExam('.$exam_id.','.$my_index.','.$std_index.','.$grade_id.')" >Editar Calificación de Examen</a>
<a href="#" class=" btn btn-primary btn-xs" onClick="showModalViewExam('.$exam_id.','.$year.','.$std_index.')"  >Ver Calificación de Examen</a>';
	
}else{
	echo'<a href="#" class=" btn btn-warning btn-xs" onClick="showModalAddExam('.$exam_id.','.$my_index.','.$std_index.','.$grade_id.')"  >Añadir Calificación de Examen</a>';
}
?>
