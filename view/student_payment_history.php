...
?>                   
			...
			<h3 class="box-title"><?php echo $name; ?> Historico de Pagos</h3>
         </div><!-- /.box-header -->
...
?>   
   ...
   <!--MSK-000115-td4--><td id="td_paid_<?php echo $count; ?>"><?php echo $row['paid']; ?></td>
                        ...
                        <td> 
<!--MSK-00102-->                                                
<a href="#" onClick="showModal3(this)" id="aView_details_<?php echo $count; ?>" class="btn btn-info btn-xs" data-id="<?php echo $index; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>">Ver Detales</a>
<a href="#" onClick="showModal4(this)" id="aView_invoice_<?php echo $count; ?>" class="btn btn-success btn-xs" data-id="<?php echo $index; ?>,<?php echo $row['_status']; ?>,<?php echo $row['paid']; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>,<?php echo $row['date']; ?>" >Mirar Factura</a>
                        </td>
                     </tr>
<?php } } ?>
				</tbody>
