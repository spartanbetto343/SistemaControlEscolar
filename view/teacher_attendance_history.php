...
<div class="content-wrapper">
    ...
    <section class="content-header">
    	<h1>
        	Asitencia del Maestro
            <small>Vista</small>
        </h1>
        <ol class="breadcrumb">
        	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Asistencia</a></li>
            <li><a href="#">Historico de Asistencia de Maestros</a></li>
        </ol>
	</section>
            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">Historico de Asistencia de Maestros</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body">
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	<button type="button" id="btnSubmit" class="btn btn-primary"  onClick="showTeacher(this)">Enviar</button><!--MSK-000108-->
                  	</div>
            	</div><!-- /.box -->
        	</div>
    	</div>
...
//MSK-000109
	...
	if(month == 'Select Month'){
		...
		$('#divMonth1').append('<span id="spanMonth" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El mes es obligatorio" ></span>');	
