...
<?php } } ?>
        		...
        		<div class=" col-md-7">
					...
					<div style="" class="text-right">
                        ...
                        <input type="button" class="btn btn-xs bg-lime-active" value="Gráfica Circular" onClick="showPieChart('<?php echo htmlspecialchars($subject, ENT_QUOTES, 'UTF-8'); ?>','<?php echo htmlspecialchars($marks, ENT_QUOTES, 'UTF-8'); ?>')"> 
                        <input type="button" class="btn btn-xs bg-orange-active" value="Gráfica de Anillos" onClick="showDoughnutChart('<?php echo htmlspecialchars($subject, ENT_QUOTES, 'UTF-8'); ?>','<?php echo htmlspecialchars($marks, ENT_QUOTES, 'UTF-8'); ?>')">
                        <input type="button" class="btn btn-xs bg-fuchsia" value="Gráfica de Linea" onClick="showLineChart('<?php echo htmlspecialchars($subject, ENT_QUOTES, 'UTF-8'); ?>','<?php echo htmlspecialchars($marks, ENT_QUOTES, 'UTF-8'); ?>')">
