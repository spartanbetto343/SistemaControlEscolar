...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Los Maestros de mi Hijo</a></li>
    	</ol>
	</section>
            ...
            <div class="col-md-7">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Los Maestros de mi Hijo</h3>
                    </div><!-- /.box-header -->
...
?>   
                                <tr>
                                    ...
                                    <td>
<!--MSK-00146 --> 
<a href="#" onClick="showTeacher(this)" class="btn btn-primary btn-xs"  data-id="<?php echo $row["t_index"]; ?>">Ver Perfil</a>
<!--
