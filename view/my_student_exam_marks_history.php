...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">El Historico de Calificaciones de Examen de Estudiantes</a></li>
        </ol>
	</section>
            ...
            <div class="col-md-5"><!-- left column -->
              	<div class="box box-primary"><!-- general form elements -->
                	<div class="box-header with-border">
                  		<h3 class="box-title">El Historico de Calificaciones de Examen de Estudiantes</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body">
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	...
                    	<button type="button" id="btnSubmit" class="btn btn-primary"  onClick="showMyStudent(this)">Enviar</button><!--MSK-000108-->
                  	</div>
            	</div><!-- /.box -->
        	</div>
    	</div>
...
//MSK-000109
	...
	if(exam == 'Select Year'){
		...
		$('#divYear1').append('<span id="spanYear" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El Año es obligatorio" ></span>');	
	...
	if(exam == 'Select Exam'){
		...
		$('#divExam1').append('<span id="spanExam" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El Examen es obligatorio" ></span>');	
	...
	if(grade == 'Select Grade'){
		...
		$('#divGrade1').append('<span id="spanGrade" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El Grado es obligatorio" ></span>');	
