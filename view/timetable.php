...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	<button type="button" class="btn btn-primary"  onClick="showTimeTable(this)">Enviar</button><!--MSK-000108-->
                  	</div>
            	</div><!-- /.box -->
        	</div>
    	</div>
				...
				document.getElementById("day").value=myArray[0];
					...
					$("form").submit(function (e) {
						...
						if(classroom == 'Select Classroom'){
							...
							$("#btnSubmit").attr("disabled", true);
							$('#divClassroom').addClass('has-error has-feedback');
							$('#divClassroom').append('<span id="spanClassroom" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="Las Clase es obligatoria" ></span>');	
						...
						if (this.readyState == 4 && this.status == 200) {	
							...
							$("form").submit(function (e) {//MSK-000147-form submit
								...
								if(teacher == 'Select Teacher'){
									...
									$('#divUpdateTeacher').append('<span id="spanUpdateTeacher" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="El maestro es obligatorio" ></span>');	
