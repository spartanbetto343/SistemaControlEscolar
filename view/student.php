                	...
                	<div class="box-header with-border">
                   	...
                   	<form role="form" action="../index.php" method="post"  enctype="multipart/form-data" id="form1" class="form-horizontal">
                		<div class="box-body" >
                        	<div class="row">
                        		<div class="col-md-6">
                                	<p class="alert-info ">Detalles del Estudiante </p>
                                    <div class="form-group" id="divIndexNumber">
                                        <div class="col-xs-3">
                                            <label for="exampleInputEmail1">Numero de Indice</label>
                                        </div>
                                        <div class="col-xs-9" id="divIndexNumber1">
                                           <input type="text" class="form-control" placeholder="Inserte un Número de Indice" name="index_number" id="index_number" autocomplete="off">  
                                        </div>                    
                                    </div>
                                     <div class="form-group" id="divFullName">
                                        ...
                                        <div class="col-xs-9" id="divFullName1">
                                           <input type="text" class="form-control" placeholder="Inserte su Nombre Completo" name="full_name" id="full_name" autocomplete="off">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divIName">
                                        <div class="col-xs-3">
                                            <label for="exampleInputEmail1">Nombre con Iniciales</label>
                                        </div>
                                        <div class="col-xs-9" id="divIName1">
                                            <input type="text" class="form-control" placeholder="Inserte un Nombre con Iniciales" name="i_name" id="i_name" autocomplete="off">
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divAddress">
                                        ...
                                        <div class="col-xs-9" id="divAddress1">
                                           <input type="text" class="form-control" placeholder="Inserte una Dirección" name="address" id="address" autocomplete="off"> 
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divEmail">
                                        ...
                                        <div class="col-xs-9" id="divEmail1">
                                           <input type="text" class="form-control" placeholder="Inserte un Correo" name="email" id="email" autocomplete="off"> 
                                        </div>                    
                                    </div>
                                    <div class="row" >
                        				<div class="col-xs-7">
                                ...
                                <div class="col-md-6">
                                	<p class="alert-info "> Detalles de Tutor </p>
                                    <div class="form-group" id="divGIndexNumber">
                                        <div class="col-xs-3">
                                            <label for="exampleInputEmail1">Número de Indice</label>
                                        </div>
                                        <div class="col-xs-9" id="divGIndexNumber1">
                                           <input type="text" class="form-control" placeholder="Inserte un Número de Indice" name="g_index" id="g_index" autocomplete="off" readonly>  
                                        </div>                    
                                    </div>
                                     <div class="form-group" id="divGFullName">
                                        ...
                                        <div class="col-xs-9" id="divGFullName1">
                                           <input type="text" class="form-control" placeholder="Inserte su Nombre Completo" name="g_full_name" id="g_full_name" autocomplete="off">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGIName">
                                        ...
                                        <div class="col-xs-9" id="divGIName1">
                                            <input type="text" class="form-control" placeholder="Inserte un Nombre con Iniciales" name="g_i_name" id="g_i_name" autocomplete="off">
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGAddress">
                                        ...
                                        <div class="col-xs-9" id="divGAddress1">
                                           <input type="text" class="form-control" placeholder="Inserte una Dirección" name="g_address" id="g_address" autocomplete="off"> 
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGEmail">
                                        ...
                                        <div class="col-xs-9" id="divGEmail1">
                                           <input type="text" class="form-control" placeholder="Inserte una Dirección de Email" name="g_email" id="g_email" autocomplete="off"> 
                                        </div>                    
                                    </div>
                                    <div class="row" >
                        				<div class="col-xs-7">
                       ...
                       <div class="box-footer text-right">
                    		...
                    		<button style="width:150px;" type="submit" class="btn text-right btn-success asd" id="btnSubmit">Siguiente</button><br>
...
$('#fileToUpload').change(function(){
	...
	if($.inArray(ext, ['png','jpg','jpeg']) == -1){
		...
		$('#divPhoto1').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"                                title="El tipo de archivo no está permitido" ></span>');
		...
		if(fileSize > maxSize) {
			...
			$('#divPhoto').addClass('has-error');
			$('#divPhoto1').addClass('has-feedback');	
			$('#divPhoto1').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="El tamaño del archivo es demasiado grande." ></span>');		
...
$('#g_fileToUpload').change(function(){
	...
	if($.inArray(ext, ['png','jpg','jpeg']) == -1){
		...
		$('#divGPhoto1').append('<span id="spanGPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"                                title="El tipo de archivo no está permitido" ></span>');
		...
		if(fileSize > maxSize) {
			...
			$('#divGPhoto').addClass('has-error');
			$('#divGPhoto1').addClass('has-feedback');	
			$('#divGPhoto1').append('<span id="spanGPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="El tamaño del archivo es demasiado grande." ></span>');		
...
$("form").submit(function (e){
	...
	if(index_number == ''){
		...
		$('#divIndexNumber').append('<span id="spanIndexNumber" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" 									 data-toggle="tooltip" title="El número de índice es obligatorio" ></span>');	
	...
	if(g_index_number == ''){
		...
		$('#divGIndexNumber').append('<span id="spanGIndexNumber" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" 									 data-toggle="tooltip" title="El número de índice es obligatorio" ></span>');	
	...
	if(full_name == ''){
		...
		$('#divFullName').append('<span id="spanFullName" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="El nombre completo es requerido" ></span>');	
	...
	if(g_full_name == ''){
		...
		$('#divGFullName').append('<span id="spanGFullName" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="El nombre completo es requerido" ></span>');	
	...
	if(i_name == ''){
		...
		$('#divIName').append('<span id="spanIName" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="Las iniciales del nombre son requeridas" ></span>');	
	...
	if(g_i_name == ''){
		...
		$('#divGIName').append('<span id="spanGIName" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="Las iniciales del nombre son requeridas" ></span>');	
	...
	if(address == ''){
		...
		$('#divAddress').append('<span id="spanAddress" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="La dirección es requerida" ></span>');	
	...
	if(g_address == ''){
		...
		$('#divGAddress').append('<span id="spanGAddress" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="La dirección es requerida" ></span>');	
	...
	if(gender == 'Select Gender'){
		...
		$('#divGender1').append('<span id="spanGender" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="El género es obligatorio" ></span>');	
	...
	if(g_gender == 'Select Gender'){
		...
		$('#divGGender1').append('<span id="spanGGender" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="El género es obligatorio" ></span>');	
	...
	if(b_date == ''){
		...
		$('#divDOB1').append('<span id="spanDOB" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="La fecha de nacimiento es obligatoria" ></span>');	
	...
	if(g_b_date == ''){
		...
		$('#divGDOB1').append('<span id="spanGDOB" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="La fecha de nacimiento es obligatoria" ></span>');	
	...
	if(email == ''){
		...
		$('#divEmail1').append('<span id="spanEmail" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="La dirección de correo electrónico es requerida" ></span>');	
		...
		if (mailformat.test(email) == false){ 
			//MSK-00108-email
			$('#divEmail').addClass('has-error has-feedback');
			$('#divEmail1').append('<span id="spanEmail" class="glyphicon glyphicon-remove form-control-feedback msk-set-color-tooltip" data-toggle="tooltip"    title="Introduzca una dirección de correo electrónico válida" ></span>');
	...
	if(g_email == ''){
		...
		$('#divGEmail1').append('<span id="spanGEmail" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="La dirección de correo electrónico es requerida" ></span>');	
		...
		if (mailformat.test(g_email) == false){ 
			//MSK-00108-email
			$('#divGEmail').addClass('has-error has-feedback');
			$('#divGEmail1').append('<span id="spanGEmail" class="glyphicon glyphicon-remove form-control-feedback msk-set-color-tooltip" data-toggle="tooltip"    title="Introduzca una dirección de correo electrónico válida" ></span>');
	...
	if(photo == ''){
		...
		$('#divPhoto1').addClass('has-feedback');
		$('#divPhoto1').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="La imagen es requerida" ></span>');	
	...
	if(g_photo == ''){
		...
		$('#divGPhoto1').addClass('has-feedback');
		$('#divGPhoto1').append('<span id="spanGPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="La imagen es requerida" ></span>');	
	...
	if(phone == ''){
		...
		$('#divPhone1').append('<span id="spanPhone" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="El número de teléfono es requerido" ></span>');	
		...
		if (telformat.test(phone) == false){ 
			...
			$('#divPhone').addClass('has-error');
			$('#divPhone1').addClass('has-error has-feedback');
			$('#divPhone1').append('<span id="spanPhone" class="glyphicon glyphicon-remove form-control-feedback msk-set-color-tooltip" data-toggle="tooltip"    title="Introduce un número de teléfono válido" ></span>');
				...
				setTimeout(function() {
					...
					var afterVal = $field.val();// this is the value after the keypress
						...
						if (telformat.test(afterVal) == true){
							...
							$('#divPhone').addClass('has-error');
							$('#divPhone1').addClass('has-error has-feedback');
							$('#divPhone1').append('<span id="spanPhone" class="glyphicon glyphicon-remove form-control-feedback msk-set-color-tooltip" data-toggle="tooltip"    title="Introduzca una dirección de correo electrónico válida" ></span>');
	...
	if(g_phone == ''){
		...
		$('#divGPhone1').append('<span id="spanGPhone" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="El número de teléfono es requerido" ></span>');	
		...
		if (telformat.test(g_phone) == false){ 
			...
			$('#divGPhone').addClass('has-error');
			$('#divGPhone1').addClass('has-error has-feedback');
			$('#divGPhone1').append('<span id="spanGPhone" class="glyphicon glyphicon-remove form-control-feedback msk-set-color-tooltip" data-toggle="tooltip"    title="Introduce un número de teléfono válido" ></span>');
      			...
      			<div class="row">
          			<div class="panel panel-primary "><!--panel --> 
            			<div class="panel-heading ">
              				<h3 class="panel-title" id="hname">Seleccionar Grado</h3>
            			</div>
