...
<div class="content-wrapper">
    ...
    <section class="content-header">
    	<h1>
        	Los Examenes de mi Hijo
            <small>Vista</small>
        </h1>
        <ol class="breadcrumb">
        	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Examen</a></li>
            <li><a href="#">El Historico de Calificaciones de Examen de mi Hijo</a></li>
        </ol>
	</section>
            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">El Historico de Calificaciones de Examen de mi Hijo</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body">
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	...
                    	<button type="button" id="btnSubmit" class="btn btn-primary"  onClick="showExamMarks(this)">Enviar</button><!--MSK-000108-->
                  	</div>
            	</div><!-- /.box -->
        	</div>
    	</div>
