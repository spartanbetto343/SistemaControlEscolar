...
$inv_number=$id2+1; 
?>                                    
                                	<h3>Factura - #<?php echo $inv_number; ?></h3>
...
?>
                                  	<tr>
                                        <td><?php echo $i+2; ?></td>
                                        <td class="">Tarifa Mensual - <?php echo $row1['s_name']; ?></td>
...
<?php } ?>                  	</tbody>
						...
						<div class="panel-footer inv-footer text-right" id="msk123456">
                    			...
                    			<button type="button" class="btn btn-primary btn-md"  id="btnSubmit1" onClick="addSPayment(this)">
                                	<small><span class="glyphicon glyphicon-usd"></span></small>Pago<!--MSK-000138-->
                                </button>
             			</div>                    
                	</div><!--/. panel--> 
                </div><!--/.row --> 
