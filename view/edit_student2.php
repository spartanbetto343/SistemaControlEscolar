            ...
            <div class="col-md-12">
              	<div class="box box-primary">
                	<div class="box-header with-border">
                        ...
                        <a href="my_student.php?do=showSTable&grade_id=<?php echo $grade_id; ?>" style="float:right" type="button" class="btn text-right btn-success asd" id="btnSubmit2"><span class="glyphicon glyphicon-arrow-left"></span> Regresar</a>
                	</div><!-- /.box-header -->
                   	<form role="form" action="../index.php" method="post"  enctype="multipart/form-data" id="form1" class="form-horizontal">
                		<div class="box-body" >
                        	<div class="row">
                        		<div class="col-md-6">
                                	<p class="alert-warning ">Detalles del Estudiante </p>
                                     <div class="form-group" id="divFullName">
                                        <div class="col-xs-3">
                                            <label for="exampleInputEmail1">Nombre Completo</label>
                                        </div>
                                        <div class="col-xs-9" id="divFullName1">
                                           <input type="text" class="form-control" placeholder="Ingresa el Nombre Completo" name="full_name" id="full_name" autocomplete="off" value="<?php echo $row['full_name']; ?>">  
                                        </div>                    
                                    </div>
...
$("form").submit(function (e){
	...
	if(g_email == ''){
		...
		$('#divGEmail1').append('<span id="spanGEmail" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="Introduzca una dirección de correo electrónico válida" ></span>');	
