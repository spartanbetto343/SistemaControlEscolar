                        ...
                        <div class="panel-body"><!--panel-body -->
                            <div class="row">
                                <div class=" col-md-12 table1-responsive"> 
                                        <h3>Salario Total por Este Mes</h3>
                                    <table class="table table-bordered table-striped" id="tableSdetails2">
                                        <thead>
                                            ...
                                            <th class="col-md-1">Conteo de Estudiantes</th>
                                            <th class="col-md-1">Carga del Salón(%)</th>
...
?>
                                   ...
                                   <p class="alert-info al"><strong>Nota1:</strong> You can get the Advance of Salary 5<sup>th</sup> to 25<sup>th</sup> Every Month.</p>
