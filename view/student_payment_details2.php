                        ...
                        <div class="panel-body"><!--panel-body -->
                            <div class="row">
                                <div class=" col-md-12 table1-responsive"> 
                                        <h3>Tarifa mensual para este mes</h3>
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <th class="col-md-1">#</th>
                                            <th class="col-md-1">Grado</th>
                                            <th class="col-md-1">Asignatura</th>
                                            <th class="col-md-1">Tarifa de Asignatura($)</th>
                                	...
                                	<div class="box">    
                                        ...
                                        <form role="form" action="../index.php" method="post" id="form1" class="form-horizontal" >
                                                ...
                                                <div class="form-group" id="divIndexNumber">
                                                    ...
                                                    <div class="col-xs-8">
                                                        <select class="form-control"  id="type" name="type">			
                                                            <option value="selectType">Seleccionar Pago</option>
                                                            <option value="Monthly Fee">Cuota Mensual</option>
                                                        </select>
                                                    </div>                    
                                                </div>
                                            ...
                                            <div class="box-footer text-right ">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-success" id="btnSubmit"><small><span class="glyphicon glyphicon-usd"></span></small>Pago</button>
                                            </div>
                                        </form>
                                	</div>        
                                </div>
