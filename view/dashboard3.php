...
-->
     ...
     <div class="row" id="table1"><!--MSK-000132-1-->    
        	<div class="col-md-8">
           		<center><h4 class="box-title">Asistencia Mensual de Mi Hijo</h4></center>
...
<br>
       ...
       <div class="row" >
            <div class="col-md-9" ><!-- left column -->
                <center><h4>Las Calificaciones de Examenes de Mi Hijo</h4></center>
...
?>
		<div class="row" id="table1"><!--MSK-000132-1-->
        	<div class="col-md-12">
            	<center><h4 class="box-title">El Horario de Mi Hijo</h4></center>
                <div class="box">
