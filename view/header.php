...
<div class="wrapper">
  <header class="main-header" >
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><strong>SIS</strong></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><strong>Sistema Escolar </strong></span>
    </a>
...
?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="footer"><a href="#" onClick="">Ver Todos</a></li>
                </ul>
              </li>
<?php } ?>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-header">
                        ...
                        <p>
                          ...
                          <small>Miembro desde noviembre de 2022</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
