...
-->
      ...
      <h5><?php echo $name; ?>,<strong><span style="color:#cf4ed4;"> Bienvenido de Nuevo! </span></strong></h5>
		...
		<div class="row" id="table1"><!--MSK-000132-1-->    
        	<div class="col-md-8">
           		<center><h4 class="box-title">Ingreso Mensual</h4></center>
...
$month=array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Deciembre");
...
?>
	...
	<div class="row" >
    	<div class="col-md-10" ><!-- left column -->
        	<center><h4>Registro Mensual de Estudiantes</h4></center>
