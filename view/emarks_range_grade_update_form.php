...
$name=$row['name'];
?>                             
          					<h3 class="panel-title"><?php echo $name; ?> Enrutamiento de Examenes</h3>
   						</div>
            			<div class="panel-body"><!-- panel-body--> 
                            
 							<a href="#" style="float:right;" onClick="showeMark('<?php echo $grade_id; ?>','<?php echo $page; ?>')" class="btn btn-success btn-xs text-right">Añadir Marca Electrónica</a><br>
