...
<div class="content-wrapper">
    ...
    <section class="content-header">
    	<h1>
        	Asignatura
            <small>Enrutamiento</small>
        </h1>
        <ol class="breadcrumb">
        	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Enrutamiento de Asignatura</a></li>
        </ol>
	</section>
        	...
        	<div class="col-md-10">
            	<div class="box">
                	<div class="box-header">
                 		<a href="#modalInsertform" onClick="" class="btn btn-success btn-sm pull-right" data-id="<?php echo $row["id"]; ?>" data-toggle="modal">Añadir <span class="glyphicon glyphicon-plus"></span></a><!-- MSK-00094-->
                  		<h3 class="box-title">Enrutamiento de Asignatura</h3>
                	</div><!-- /.box-header -->
                	<div class="box-body table-responsive">
                		...
                		<table id="example1" class="table table-bordered table-striped">
                            <thead>
                                ...
                                <th class="col-md-4">Maestro</th>
                                <th class="col-md-1">Tarifa($)</th>
...
if(mysqli_num_rows($result1) > 0) {
	...
	echo '<a href="#" id="edit1_sfee_'.$count.'" onClick="editSubjectFee(this)" class="btn btn-warning btn-xs cant-edit" data-id="'.$sr_id.','.$count.','.$row["s_fee"].'" >Editar Tarifa</a>';

}else{
	
	echo '<a href="#modalUpdateform" id="edit_sfee_'.$count.'" onClick="showModal(this)" class="btn btn-info btn-xs" data-id="'.$sr_id.','.$count.'" data-toggle="modal">Editar</a>';  
	echo ' <a href="#" class="confirm-delete btn btn-danger btn-xs" id="delete_sfee_'.$count.'" data-id="'.$sr_id.'">Eliminar</a>'; 
...
<?php }} ?> 	           
                                ...
                                <div class="form-group" id="divTeacher">
        							...
        							<select class="form-control"  id="teacher" name="teacher_id">			
     									<option>Seleccionar Maestros</option>
<?php
//MSK-00098
include_once('../controller/config.php');
...
<?php }} ?>	          
                                ...
                                <div class="form-group" id="divFee">
        							...
        							<input type="text" class="form-control" id="fee" name="fee"  placeholder="Insertar una Tarifa" autocomplete="off"/>
        						</div>  
            				...
            				<div class="panel-footer bg-blue-active">
                    			...
                    			<button type="submit" class="btn btn-info " id="btnSubmit" style="width:100%;">Enviar</button>
             				</div>
             			</form>       
      				</div><!--/.panel-->
         		</div><!--/.col-md-3 --> 
...
$("form").submit(function (e) {
	...
	if(grade == 'Select Grade'){
		...
		$('#divGrade').append('<span id="spanGrade" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El Grado es requerido" ></span>');	
	...
	if(teacher == 'Select Teacher'){
		...
		$('#divTeacher').append('<span id="spanTeacher" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El Maestro es obligatorio" ></span>');	
	...
	if(fee == ''){
		...
		$('#divFee').append('<span id="spanFee" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La tarifa es obligatoria" ></span>');	
...
<!-- //MSK-00103 Modal-modalUpdateform-->  
                    ...
                    <div class="col-md-3 ">
                        <div class="panel">
                            <div class="panel-heading bg-orange">               
        						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          						<h3 class="panel-title">Editar Enrutamiento de Asignatura</h3>
   							</div>
    ...
    <?php }} ?>	          
                                ...
                                <div class="form-group" id="divFeeUpdate">
                                    <label for="" >Tarifa($)</label>
                                    <input type="text" class="form-control" id="fee1" name="fee"  placeholder="Inserte una tarifa" autocomplete="off"/>
                                </div>  
                            </div><!--/.modal body-->
                            <div class="panel-footer bg-gray-light">
                            	<input type="hidden" id="count1" value="">
                                <button type="button" class="btn btn-info" id="btnSubmit1" onClick="UpdateSubjectFee(this)" style="width:100%;"><span class="glyphicon glyphicon-ok-sign"></span>Actualizar</button><!--MSK-000108-->
                            </div><!--/.panel-footer-->
                        </div><!--/.panel-->
                    </div><!--/.col-md-3 --> 
                </div><!--/.row-->      
...
function UpdateSubjectFee(){
	...
	if(fee == ''){
		...
		$('#divFeeUpdate').append('<span id="spanFeeUpdate"  class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="La tarifa es requerida" ></span>');
