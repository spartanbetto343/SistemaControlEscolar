                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-md-4">
                                        <select name="category" class="form-control" id="category_update" style="width:105%;"><!--MSK-000107-->
                                    		...
                                    		<option value="1">Todos los Estudiantes y Maestros</option>
                                            <option value="2">Solo Estudiantes</option>
                                            <option value="3">Solo Maestros</option> 
                                		</select> 
                            		</div> 
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-md-4">
                                        <select name="category_type" class="form-control" id="type_update" style="width:105%;"><!--MSK-000107-->
                                            ...
                                            <option value="2">Solo mis Estudiantes</option>
                                            <option value="3">Grados Especificos</option>
                                		</select> 
                            		</div> 
                            	</div> 
...
<?php }} ?>
            				...
            				<div class="panel-footer bg-blue-active">
                    			...
                    			<button type="submit" class="btn btn-info btnS" id="btnSubmit4" style="width:100%;">Actualizar</button>
             				</div>
             			</form>      
      				</div><!--/.panel-->
         		</div><!--/.col-md-3 --> 
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">¿Esta Seguro?</strong>  ¿Quieres eliminar Este Evento?
        		</div>
