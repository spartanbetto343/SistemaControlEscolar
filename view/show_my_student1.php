...
if(mysqli_num_rows($result3) > 0){
	...
	echo '<a href="#" class="btn btn-primary btn-xs " onClick="showModalViewExam('.$exam_id.','.$year.','.$std_index.')" >Ver Calificación de Examen</a>';

}else{
	
	echo '<a href="#" class="btn btn-primary btn-xs disabled" onClick="showModalViewExam('.$exam_id.','.$year.','.$std_index.')" >Ver Calificación de Examen</a>';
