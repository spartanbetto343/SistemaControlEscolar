...
<?php }} ?> 	           
                                ...
                                <div class="form-group" id="divStartTime">
        							...
        							<input type="text" class="form-control" id="start_time" name="start_time"  placeholder="Inserta la hora de Inicio" autocomplete="off"/>
        						</div>  
                                 <div class="form-group" id="divEndTime">
                					<label for="" >Hora de Termino</label>
        							<input type="text" class="form-control" id="end_time" name="end_time"  placeholder="Inserta la Hora de Termino" autocomplete="off"/>
        						</div>  
            				</div><!--/.modal body-->
