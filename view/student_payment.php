...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Pago del Estudiante</a></li>
    	</ol>
	</section>
                	...
                	<div class="box-header with-border">
                  		...
                  		<div class="box-body">
                    		<div class="form-group" id="divIndex">
                      			<label for="">Número de Indice</label>
                      			<input type="text" class="form-control" id="index_number" placeholder="Inserta un Numero de Indice" name="index_number" autocomplete="off" onChange="this.value">
                    		</div>
                  		</div><!-- /.box-body -->
                  		<div class="box-footer">
                    		<button type="button" class="btn btn-primary" id="btnSubmit" onClick="showPayment(this)">Enviar</button>
                  		</div>
				</div><!-- /.box -->
			</div>
		</div>
...
function showPayment(){
	...
	if(index == ''){
		...
		$('#divIndex').append('<span id="spanIndex" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El número de indice es requerido" ></span>');	
						...
						var xhttp = new XMLHttpRequest();
							xhttp.onreadystatechange = function() {
								...
								if (this.readyState == 4 && this.status == 200) {
									...
									if(lastPaid == 0){
										document.getElementById('lastMonth').innerHTML = "No asististe el mes pasado..!";
										document.getElementById('mFee_lMonth').innerHTML = "No hay datos...!";
										document.getElementById('lastPaid').innerHTML = "No hay datos...!";
									}
				...
				$("#amount").keydown(function(){
					...
					setTimeout(function() {
							...
							if(amount != MFee){
								...
								$('#divAmount').append('<span id="spanAmount" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="El monto no es igual a la Cuota Mensual" ></span>');
								$("#btnSubmit").attr("disabled", true);
