            		...
            		<div class="panel panel-primary">
        				<div class="panel-heading">               
        					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          					<h3 class="panel-title">Añadir Enrutamniento de Asignatura </h3>
   						</div>
...
<?php }} ?> 	           
                                ...
                                <div class="form-group" id="divClassroom">
        							...
        							<select class="form-control"  id="classroom" name="classroom_id"><!--MSK-000116-classroom-->			
     									<option>Seleccioanr Clase</option>
<?php
include_once('../controller/config.php');
...
<?php }} ?> 	           
                                ...
                                <div class="form-group" id="divStartTime">
        							...
        							<input type="text" class="form-control" id="start_time" name="start_time"  placeholder="Inserte la Hora de Inicio" autocomplete="off"/>
        						</div>  
                                 <div class="form-group" id="divEndTime">
                					<label for="" >Hora de Termino</label>
        							<input type="text" class="form-control" id="end_time" name="end_time"  placeholder="Inserte la hora de Termino" autocomplete="off"/>
        						</div>  
            				</div><!--/.modal body-->
