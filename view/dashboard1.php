        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
            	<span class="info-box-text">Número de Estudiantes</span>
<?php
include_once('../controller/config.php');
...
?>               
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
            	<span class="info-box-text">Número de Maestros</span>
<?php
include_once('../controller/config.php');
...
<!--
 ...
 -->
      ...
      <!-- /.row -->
     <h5><?php echo $name; ?>,<strong><span style="color:#cf4ed4;"> Bienvenido de Nuevo! </span></strong></h5>
     
     <div class="row" id="table1"><!--MSK-000132-1-->    
        	<div class="col-md-8">
           		<center><h4 class="box-title">Asistencia Mensual</h4></center>
...
function showBarChart(monthly_attendance){	
	...
	new Chart(document.getElementById("barChart"), {
		...
		data: {
		   ...
		   labels: ["Enero", "Febreo", "Marzo", "Abril", "Mayo", "Junio","Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Deciembre"],
		  datasets: [
			{
...
$month=array("Enero", "Febreo", "Marzo", "Abril", "Mayo", "Junio","Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Deciembre");
...
<br>
       ...
       <div class="row" >
            <div class="col-md-9" ><!-- left column -->
                <center><h4>Mis Notas de Examenes</h4></center>
...
?>
		<div class="row" id="table1"><!--MSK-000132-1-->
        	<div class="col-md-12">
            	<center><h4 class="box-title">Mi Horario</h4></center>
                <div class="box">
