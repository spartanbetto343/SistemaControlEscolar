...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Añadir Asistencia</a></li>
    	</ol>
	</section>
            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">Añadir Asistencia</h3>
                	</div><!-- /.box-header -->
                    <form role="form" action="../index.php" method="post" id="form1" >
                  		<div class="box-body">
                    		<div class="form-group" id="divIndex">
                      			<label for="">Numero de indice</label>
                      			<input type="text" class="form-control" id="index_number" placeholder="Ingresa el numero de indice" name="index_number" autocomplete="off" onChange="this.value">
                    		</div>
                  		</div><!-- /.box-body -->
