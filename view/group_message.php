			...
			<div class="col-md-10">
            	<div class="box">
                	<div class="box-header">
                  		<h3 class="box-title">Todos los Mensajes Grupales</h3>
                        <a href="#" onClick="cNewMessage('<?php echo $my_index; ?>','<?php echo $my_type; ?>')" class="btn btn-sm  bg-orange-active pull-right " data-id="" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> Crear Nuevo </a><!-- MSK-00094--> 
                	</div><!-- /.box-header -->
...
if(mysqli_num_rows($result) > 0){
	while($row=mysqli_fetch_assoc($result)){
		...
		if($group == 1){
			...
			$group = "Todos los Maestros y Estudiantes";
		}else if($group == 3){
			$group = "Todos los Maestros y Grados Especificos";
		}else if($group == 4){
			$group = "Solo Grados Especificos";
		}else if($group == 5){
			$group = "Solo Maestros";
		}else if($group == 6){
			$group = "Solo Estudiantes";
		}else if($group == 7){
			$group = "Solo Padres";
		}else{
...
?>   
                        		<tr>
                                    ...
                                    <td> <?php echo $row['time']; ?> </td>
             						<td> 
            <a href="#modalModalGMessage" onClick="showModalGMessage('<?php echo $row['id']; ?>')" class="btn btn-warning btn-xs" data-id="" data-toggle="modal">Ver Mensaje</a>
                                    </td>
                            	</tr>
<?php } } ?>
                        	</tbody>
