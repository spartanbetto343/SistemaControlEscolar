...
<button href="#" class="confirm-delete btn btn-xs btn-danger" data-id="<?php echo $my_index; ?>,<?php echo $friend_type; ?>,<?php echo $friend_index; ?>" ><i class="fa fa-user-plus" aria-hidden="true"> Borrar Petición</i></button>  
</a>
<?php } } ?> 
