            ...
            <div class="col-xs-6"><!-- left column -->
              	<div class="box box-primary"><!-- general form elements -->
                	<div class="box-header with-border">
                  		<h3 class="box-title">Seleccionar Grado</h3>
                	</div><!-- /.box-header -->
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	<button type="button" class="btn btn-primary"  onClick="showStudentTable(this)">Enviar</button><!--MSK-000108-->
                  	</div>
              	</div><!-- /.box -->
            </div>
		</div>
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">¿Estas Seguro?</strong>  ¿Quieres Eliminar a este Estudiante?
        		</div>
                			...
                			<div class=" col-md-9"> 
                  				<table class="table table-user-information">
                    				<tbody>
                                        ...
                                        <tr>
                        					<td>Padre del Tutor</td>
                        					<td id="g_name2"> </td>
                      					</tr>
                        				<tr>
                        					<td>Dirección del Tutor</td>
                        					<td id="g_address2"> </td>
                      					</tr>
                      					<tr>
	...
	<div class="modal msk-fade " id="upgradeConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  		<div class="modal-dialog">
    		<div class="modal-content">
				<div class="modal-header bg-primary">
        			<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        			<h4 class="modal-title" id="frm_title">Actualizar</h4>
      			</div>

				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">¿Estás seguro?</strong>  ¿Quieres actualizar este estudiante?
        		</div>
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYes1" class="deletebtn btn btn-danger col-sm-2 pull-right">Si</a><!-- MSK-000132 -->
        			<button type="button" class="btn btn-primary col-sm-2 pull-right" data-dismiss="modal" id="frm_cancel">No</button>
      			</div>
    		</div>
  		</div>
