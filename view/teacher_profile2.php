            	...
            	<div class="panel"><!--panel bg-maroon--> 
                    ...
                    <div class="panel-body"><!--panel-body -->
                    	<div class="row"  id="my_profile">
                         ...
                         <p class="alert-info" id="note1"><strong>Nota: Ocupamos la dirección de correo electrónico para el nombre de usuario.</strong></p>
                     </div>
						...
						if (this.readyState == 4 && this.status == 200) {
							...
							$("form").submit(function (e){
								...
								if(full_name == ''){
									...
									$('#tdFullName2').append('<span id="spanFullName" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="El nombre completo es requerido" ></span>');	
								...
								if(phone == ''){
									...
									$('#tdPhone2').append('<span id="spanPhone" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"   title="El número de teléfono es requerido" ></span>');	
