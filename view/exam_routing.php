...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Enrutamiento de Examenes</a></li>
        </ol>
	</section>
            	...
            	<div class="box">
                	<div class="box-header">
                 		<a href="#modalInsertform" onClick="" class="btn btn-success btn-sm pull-right" data-toggle="modal">Add <span class="glyphicon glyphicon-plus"></span></a><!-- MSK-00094-->
                  		<h3 class="box-title">Enrutamiento de Examenes</h3>
                	</div><!-- /.box-header -->
                	<div class="box-body table-responsive">
                		...
                		<table id="example1" class="table table-bordered table-striped">
                            <thead>
                                ...
                                <th class="col-md-1">Examen</th>
                                <th class="col-md-4">Asignatura</th>
...
?>   
               ...
               <!--MSK-000115-td3--><td id="td3_<?php echo $row1['exr_id']; ?>"><?php echo $row1['s_name']; ?></td>
                                    <td> 
<!--MSK-00102-->                                                
<a href="#modalUpdateform" onClick="showModal(this)" class="btn btn-info btn-xs" data-id="<?php echo $row1['exr_id']; ?>" data-toggle="modal">Ver</a>
<!--MSK-00121-->
<a href="#" class="confirm-delete btn btn-danger btn-xs"  data-id="<?php echo $g_id; ?>,<?php echo $e_id; ?>,<?php echo $s_id; ?>">Eliminar</a>
                               		</td>
                            	</tr>
<?php } } ?>
                        	</tbody>
            		...
            		<div class="panel panel-primary">
        				<div class="panel-heading">               
        					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          					<h3 class="panel-title">Añadir Enrutamiento de Examen</h3>
   						</div>
...
<?php }} ?> 	           
            				...
            				<div class="panel-footer bg-blue-active">
                    			...
                    			<button type="submit" onClick="" class="btn btn-info btnS" id="btnSubmit" style="width:100%;">Enviar</button>
             				</div>
             			</form>       
      				</div><!--/.panel-->
         		</div><!--/.col-md-3 --> 
...
//$("#modalInsertform").on("click", ".btnS", function (e) {
	...
	if(exam == 'Select Exam'){
		...
		$('#divExam').append('<span id="spanExam" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El Examen es requerido" ></span>');	
...
function UpdateSubjectFee(){
	...
	if(fee == ''){
		...
		$('#divFeeUpdate').append('<span id="spanFeeUpdate"  class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="La tarifa es obligatoria" ></span>');
