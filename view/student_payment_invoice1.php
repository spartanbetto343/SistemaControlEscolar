...
?>                                    
                                ...
                                <div class="col-xs-5 col-xs-offset-2 text-right msk-t">
                                    ...
                                    <div class="text-right">
                                    	Año: <?php echo $year; ?><br>
                                        Mes: <?php echo $month; ?><br>
                                    	Fecha: <?php echo $date; ?>
                                    </div>                                
                                </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-xs-3 text-right pdetail2">
    								<p>
                                      <strong>
                                        <span id="spanaFee1">Tarifa de Admisión :</span>
                                        Cuota Mensual :<br>
										Total :<br>
                                        Pago :<br>
                                      </strong>
                        ...
                        <div class="panel-footer inv-footer text-right" id="msk123456">
                        	<button type="button" class="btn btn-success btn-md"  id="" onClick="window.print()">
                            	<span class="glyphicon glyphicon-print"></span> IMPRIMIR<!--MSK-000137--> 
                            </button>
             			</div>
                	</div><!--/. panel--> 
                </div><!--/.row --> 
