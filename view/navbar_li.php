...
?>              
                ...
                <ul class="dropdown-menu" id="dropdown_menu_frequest">
                  <li class="header">You have <?php echo $unread_count; ?> peticion de amistad</li>
...
<button onClick="confirmFriend('<?php echo $my_index; ?>','<?php echo $my_type; ?>','<?php echo $friend_index; ?>')" class="btn btn-xs bg-green-active"><i class="fa fa-user-plus" aria-hidden="true"> Confirmar</i></button>
<button href="#" class="confirm-delete btn btn-xs btn-danger" data-id="<?php echo $my_index; ?>,<?php echo $friend_type; ?>,<?php echo $friend_index; ?>" ><i class="fa fa-user-plus" aria-hidden="true"> Eliminar Petición</i></button>  
</a>
<?php } } ?> 
                  ...
                  <li class="footer"><a href="#">Ver Todas las Peticiones de Amistad</a></li>
                </ul>
              </li>           
<?php 
include_once('../controller/config.php');
