  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">¿Estas Seguro?</strong>  ¿Quieres Eliminar el Registro de Este Estudiante?
        		</div>
	...
	<div class="modal msk-fade " id="upgradeConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">¿Estas Seguro?</strong>  ¿Quieres actualizar este estudiante?
        		</div>
      			<div class="modal-footer">
