                    ...
                    <div id="calendar-container">
                        ...
                        <div class="col-md-7" >
                           ...
                           <button type="button" class="btn btn-info btn-md"  id="btnShow" onClick="ShowEvents1(this)">
                                <i class="fa fa-calendar" aria-hidden="true"></i> Mostrar<!--MSK-000138-->
                           </button>
                           <input type="hidden" id="my_index" value="<?php echo $my_index; ?>">  
                           <input type="hidden" id="my_type" value="<?php echo $my_type; ?>">                         
                        </div>
                        <div class="col-md-1">
                        	<a href="#" onClick="createEvents('<?php echo $my_index; ?>','<?php echo $my_type; ?>')" class="btn btn-sm  bg-orange-active pull-right " data-id="" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> Crear Evento </a><!-- MSK-00094--> 
                        </div>
                        <br><br>
			...
			if (this.readyState == 4 && this.status == 200) {
				...
				$("form").submit(function (e) {
					...
					if(title == ''){
						...
						$('#divTitle').append('<span id="spanTitle" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El titulo es requerido" ></span>');	
					...
					if(category == 0){
						...
						$('#divCategory1').append('<span id="spanCategory" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La categoría es obligatoria" ></span>');	
					...
					if(datetime == ''){
						...
						$('#divDate').append('<span id="spanDate" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La fecha y la hora son obligatorias" ></span>');	
					...
					if(note == ''){
						...
						$('#divNote').append('<span id="spanNote" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La nota es obligatoria" ></span>');	
...
function get_calendar(day_no,days){
	...
	for(var c=0; c<=6; c++){
		...
		th.innerHTML =  ['Domingo','Lunes','Martes','Miercoles','Jueves','Viernes','Sabado'][c];
		tr.appendChild(th);
		th.className = "tHead";
                                ...
                                <div class="form-group" id="divCategoryUpdate">
                                    ...
                                    <div class="input-group col-md-4" id="divCategoryUpdate1">
                                        <select name="category" class="form-control" id="category_update" style="width:105%;"><!--MSK-000107-->
                                            ...
                                            <option value="3">Todos los Maestros y Grados Especificos</option>
                                            <option value="4">Solo Grados Especificos</option>
...
<?php }} ?>
            				...
            				<div class="panel-footer bg-blue-active">
                    			...
                    			<button type="submit" class="btn btn-info btnS" id="btnSubmit1" style="width:100%;">Actualizar</button>
             				</div>
             			</form>      
      				</div><!--/.panel-->
         		</div><!--/.col-md-3 --> 
			...
			if (this.readyState == 4 && this.status == 200) {
				...
				$("#form1").submit(function (e) {
					...
					if(title == ''){
						...
						$('#divTitleUpdate').append('<span id="spanUTitle" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El titulo es requerido" ></span>');	
					...
					if(category == 0){
						...
						$('#divCategoryUpdate1').append('<span id="spanUCategory" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La categoría es obligatoria" ></span>');	
					...
					if(datetime == ''){
						...
						$('#divDateUpdate').append('<span id="spanUDate" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La fecha y la hora son obligatorias" ></span>');	
					...
					if(note == ''){
						...
						$('#divNoteUpdate').append('<span id="spanUNote" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La nota es obligatoria" ></span>');	
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">¿Estas Seguro?</strong>  ¿Quieres Eliminar Este Evento?
        		</div>
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYes" class="deletebtn btn btn-danger col-sm-2 pull-right">Si</a><!-- MSK-000132 -->
