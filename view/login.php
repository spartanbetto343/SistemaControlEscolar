...
<body onLoad="login()">
	...
	<img src="../uploads/fondo_blanco.jpg" class="bg" />
    	...
    	<div class="modal-dialog">    
        	<div class="modal-content ">
        		<div class="modal-header bg-aqua-gradient">
          			<center><h2><strong>Control Escolar</strong></h2></center>
        		</div>
        			...
        			<form role="form" action="../index.php" method="post">                    
                  		<div class="box-body">
                    		<div class="form-group" id="divEmail">
                      			...
                      			<input type="text" class="form-control" id="email" placeholder="Inserte su correo electrónico" name="email" autocomplete="off">
                    		</div>
                            <div class="form-group" id="divPassword">
                      			<label for="">Contraseña</label>
                      			<input type="password" class="form-control" id="password" placeholder="Inserte su contraseña" name="password" autocomplete="off">
                    		</div>
                  		</div><!-- /.box-body -->
                  		<div class="box-footer">
                  			<input type="hidden" name="do" value="user_login" />
                    		<center><button type="submit" class="btn btn-info" id="btnSubmit">Iniciar Sesión</button></center>
                  		</div>
                	</form>
        		</div>
      		</div>      
	...
	<div class="modal fade" id="login_error" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Advertencia!</strong> Correo o 
