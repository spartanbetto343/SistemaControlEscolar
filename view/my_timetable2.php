...
<?php $index=$_SESSION["index_number"]; ?> 
                        ...
                        <a href="#" onClick="showModal(this)" class="btn btn-success btn-sm pull-right" data-id="<?php echo $index; ?>">Añadir <span class="glyphicon glyphicon-plus"></span></a><!--MSK-000113-->
                        <h3 class="box-title">Mi Horario </h3>
                    </div><!-- /.box-header -->
...
?>    	
                                        ...
                                        <a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs" data-id="<?php echo $row['tt_id']; ?>,<?php echo $index; ?>" data-toggle="modal">Editar</a><br><!--MSK-00131-Sunday-->  
                 <!--MSK-00150-Sunday--><a href="#" class="confirm-delete btn btn-danger btn-xs" data-id="<?php echo $row['tt_id']; ?>">Eliminar</a><br>
...
<?php	
	...
	echo'<br><br><br><a id="a1" href="#" onClick="showModal1(this)" class="btn btn-success btn-xs" data-id="Sunday,'.$index.'" data-toggle="modal">Añadir	         <span class="glyphicon glyphicon-plus"></span></a>';//MSK-00129-Sunday
...
<?php 
	...
	echo'<br><br><br><a id="a1" href="#" onClick="showModal1(this)" class="btn btn-success btn-xs" data-id="Monday,'.$index.'" data-toggle="modal">Añadir	         <span class="glyphicon glyphicon-plus"></span></a>';//MSK-00129-Sunday
...
<?php	
	...
	echo'<br><br><br><a id="a1" href="#" onClick="showModal1(this)" class="btn btn-success btn-xs" data-id="Tuesday,'.$index.'" data-toggle="modal">Añadir 	         <span class="glyphicon glyphicon-plus"></span></a>';//MSK-00129-Sunday
...
<?php	
	...
	echo'<br><br><br><a id="a1" href="#" onClick="showModal1(this)" class="btn btn-success btn-xs" data-id="Wednesday,'.$index.'" data-toggle="modal">Añadir 	         <span class="glyphicon glyphicon-plus"></span></a>';//MSK-00129-Sunday
...
<?php
	...
	echo'<br><br><br><a id="a1" href="#" onClick="showModal1(this)" class="btn btn-success btn-xs" data-id="Thursday,'.$index.'" data-toggle="modal">Añadir	         <span class="glyphicon glyphicon-plus"></span></a>';//MSK-00129-Sunday
...
<?php
	...
	echo'<br><br><br><a id="a1" href="#" onClick="showModal1(this)" class="btn btn-success btn-xs" data-id="Friday,'.$index.'" data-toggle="modal">Añadir	         <span class="glyphicon glyphicon-plus"></span></a>';//MSK-00129-Sunday
...
<?php
	...
	echo'<br><br><br><a id="a1" href="#" onClick="showModal1(this)" class="btn btn-success btn-xs" data-id="Saturday,'.$index.'" data-toggle="modal">Añadir 	         <span class="glyphicon glyphicon-plus"></span></a>';//MSK-00129-Sunday
    		...
    		if (this.readyState == 4 && this.status == 200) {	
				...
				//MSK-000126-form submit
					...
					if(day == 'Select Day'){
						...
						$('#divDay').append('<span id="spanDay" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El dia es obligatorio" ></span>');	
					...
					if(grade == 'Select Grade'){
						...
						$('#divGrade').append('<span id="spanGrade" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="El grado es obligatorio" ></span>');	
					...
					if(subject == 'Select Subject'){
						...
						$('#divSubject').append('<span id="spanSubject" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La Asignatura es obligatoria" ></span>');	
					...
					if(classroom == 'Select Classroom'){
						...
						$('#divClassroom').append('<span id="spanClassroom" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La Clase es obligatoria" ></span>');	
					...
					if(start_time == ''){
						...
						$('#divStartTime').append('<span id="spanStartTime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La hora de Inicio es obligatoria" ></span>');	
					...
					if(end_time == ''){
						...
						$('#divEndTime').append('<span id="spanEndTime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="La hora de termino es obligatoria" ></span>');	
						...
						if (this.readyState == 4 && this.status == 200) {	
							...
							$("form").submit(function (e) {//MSK-000147-form submit
								...
								if(subject == 'Select Subject'){
									...
									$('#divUpdateSubject').append('<span id="spanUpdateSubject" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="La Asignatura es obligatoria" ></span>');	
								...
								if(start_time == ''){
									...
									$('#divUpdateSTime').append('<span id="spanUpdateSTime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="La hora de inicio es obligatoria" ></span>');	
								...
								if(end_time == ''){
									...
									$('#divUpdateETime').append('<span id="spanUpdateETime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="La hora de termino es obligatoria" ></span>');	
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">¿Estas Seguro?</strong>  Quieres Eliminar este Registro
        		</div>
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYes" class="deletebtn btn btn-danger col-sm-2 pull-right">Si</a><!-- MSK-000154 -->
